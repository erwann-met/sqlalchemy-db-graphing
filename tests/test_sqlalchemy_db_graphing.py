...
from sqlalchemy_db_graphing.sqlalchemy_db_graphing import generate_graph_as_pydot, generate_graph_as_png, generate_graph_as_svg
...
def test_legend(test_databases: Dict):
    ...
    for database in test_databases.values():
        ...
        graph = generate_graph_as_pydot(metadata=database.metadata, display_legend=False)
